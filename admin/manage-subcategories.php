...
<html lang="en">
    <head>
        ...
        <title>SciTech | Manage Sub Categories</title>
...
<button id="addToTable" class="btn btn-primary waves-effect waves-light">Add <i class="mdi mdi-plus-circle-outline" ></i></button>
</a>
 </div>
