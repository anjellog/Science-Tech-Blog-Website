...
<a href="manage-subcategories.php">
                            <div class="col-lg-3 col-md-6 col-sm-6">
                                <div class="card-box widget-box-one">
                                    ...
                                    <div class="wigdet-one-content">
                                        <p class="m-0 text-uppercase font-600 font-secondary text-overflow" title="User This Month">Sub Categories Listed</p>
...
?>
      ...
      <a href="trash-posts.php"> <div class="col-lg-3 col-md-6 col-sm-6">
                                <div class="card-box widget-box-one">
                                    <i class="mdi mdi-layers widget-one-icon"></i>
                                    <div class="wigdet-one-content">
                                        <p class="m-0 text-uppercase font-600 font-secondary text-overflow" title="User This Month">Deleted Posts</p>
